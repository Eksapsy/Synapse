...
class Neuron {
  ...
  transmit(charge) {
    ...
    console.log('Recieved charge ', charge.toFixed(2), ' with bias of ', this.bias.toFixed(2), ' transmitting:', output.toFixed(2), ' making the average neural output ', average.toFixed(2));
